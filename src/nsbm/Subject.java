...
public class Subject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Optional Subject");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        si.setSubName(txtSubjectName.getText());
        si.setSubCode(txtSubjectCode.getText());
        si.setSubCredit(txtSubjectCredit.getText());
        si.setFaculty(ddFaculty.getSelectedItem().toString());
       
        
        
        boolean result = dbops.addSubject(si);
